# run-eda-1.ps1
# EDA-1 Pipeline: runs the R analysis script then renders the Quarto report.
# Run from the project root: powershell -File "scripts/ps1/run-eda-1.ps1"

$ErrorActionPreference = "Stop"

Write-Host "EDA-1 PIPELINE" -ForegroundColor Cyan
Write-Host "==============" -ForegroundColor Cyan
Write-Host ""

# Step 1: Run the R analysis script
Write-Host "Step 1/2 - Running R analysis script: analysis/eda-1/eda-1.R" -ForegroundColor Yellow

try {
    Rscript "analysis/eda-1/eda-1.R"
...
Write-Host "Step 2/2 - Rendering Quarto report: analysis/eda-1/eda-1.qmd" -ForegroundColor Yellow
...
Write-Host ""
Write-Host "EDA-1 pipeline finished at $(Get-Date -Format 'HH:mm:ss')" -ForegroundColor Cyan

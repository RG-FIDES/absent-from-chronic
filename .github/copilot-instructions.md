<!-- CONTEXT OVERVIEW -->
Total size: 10.7 KB (~2,735 tokens)
- 1: Core AI Instructions  | 3.7 KB (~951 tokens)
...
- 3: Additional Context     | 4.7 KB (~1,196 tokens)
  ...
  -- project/mission (default)  | 0.5 KB (~139 tokens)
...
Full rules are maintained in `.github/instructions/markdown.instructions.md`, which the IDE applies automatically to any `.md` file in the repository.

...
**Key Analytical Questions:** - How does cylinder count relate to horsepower? (g2 visualization) - How does cylinder count relate to fuel efficiency? (g21 visualization) - What other performance patterns emerge from the same cylinder-based data preparation? - How does the graph family pattern help isolate data preparation while enabling multiple analytical perspectives?
...
**Graph Family Pattern:** - ds0 → g2-data-prep → g2_data → **multiple visualizations** (g2, g21, g22...) - **Key insight**: All family members share the same data preparation but explore different aspects of monothematic idea (e.g cylinder-based performance)
